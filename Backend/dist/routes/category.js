...
router.get('/', auth_1.authenticate, categoryController_1.CategoryController.getAllCategories);
router.get('/:id', auth_1.authenticate, categoryController_1.CategoryController.getCategory);
