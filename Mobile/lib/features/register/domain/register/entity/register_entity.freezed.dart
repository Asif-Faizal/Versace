...
abstract class $RegisterEntityCopyWith<$Res> {
  factory $RegisterEntityCopyWith(
    ...
    $Res Function(RegisterEntity) then,
...
abstract class _$$RegisterEntityImplCopyWith<$Res>
    implements $RegisterEntityCopyWith<$Res> {
  factory _$$RegisterEntityImplCopyWith(
    _$RegisterEntityImpl value,
...
class __$$RegisterEntityImplCopyWithImpl<$Res>
  ...
  __$$RegisterEntityImplCopyWithImpl(
    _$RegisterEntityImpl _value,
    $Res Function(_$RegisterEntityImpl) _then,
  ) : super(_value, _then);
...
class _$RegisterEntityImpl implements _RegisterEntity {
  ...
  @override
  String toString() {
    return 'RegisterEntity(id: $id, email: $email, firstName: $firstName, lastName: $lastName, role: $role, accessToken: $accessToken, refreshToken: $refreshToken)';
  }
